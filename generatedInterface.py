...
"border-radius: 15px;")
        ...
        self.database_table.viewport().setProperty("cursor", QtGui.QCursor(QtCore.Qt.PointingHandCursor))
...
"    min-height: 8px;\n"
"}")
        self.database_table.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
...
"border-radius:15px;")
        ...
        self.archivoButton_archivo = QtWidgets.QPushButton(self.pantallaAnadirArchivo)
        self.archivoButton_archivo.setMinimumSize(QtCore.QSize(200, 50))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.archivoButton_archivo.setFont(font)
        self.archivoButton_archivo.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.archivoButton_archivo.setStyleSheet("background-color: rgb(90, 99, 156);\n"
"color:#ffffff;\n"
"border-radius:15px;")
        self.archivoButton_archivo.setObjectName("archivoButton_archivo")
        self.horizontalLayout_4.addWidget(self.archivoButton_archivo)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.archivoButton_archivo.setText(_translate("MainWindow", "Seleccionar archivo"))
import resources_rc
