...
"border-radius: 30px;")
        ...
        self.verticalSpacer_2 = QSpacerItem(20, 5, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)
...
"border-radius: 15px;")
        ...
        self.gridLayoutWidget.setGeometry(QRect(0, 10, 251, 152))
...
"background-color: rgb(0, 255, 255);")
        ...
        self.frame_24.setMaximumSize(QSize(16777215, 500))
...
"border-radius: 15px;")
        ...
        self.frame_25.setStyleSheet(u"background-color: #FFFFFF;\n"
"border-radius: 15px;")
        ...
        self.pushButton = QPushButton(self.pantallaAnadirArchivo)
        self.pushButton.setObjectName(u"pushButton")

        self.horizontalLayout_4.addWidget(self.pushButton)

        self.pushButton_2 = QPushButton(self.pantallaAnadirArchivo)
        ...
        self.mainButton_visualizacion.toggled.connect(self.frame_2.setHidden)
        self.mainButton_visualizacion.toggled.connect(self.frame_2.setVisible)
