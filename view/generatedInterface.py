...
from controller.actions import ViewerActions
...
class Ui_MainWindow(object):
        ...
        "border-radius: 15px;")
                ...
                self.frame_12.setMinimumSize(QtCore.QSize(200, 160))
        ...
        "")
                ...
                self.frame_13.setGeometry(QtCore.QRect(0, 20, 250, 131))
        ...
        "border-radius: 15px;")
                ...
                self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 10, 251, 111))
                ...
                icon5 = QtGui.QIcon()
                icon5.addPixmap(QtGui.QPixmap(":/icons/Assets/ruler.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
                self.toolButton_regla.setIcon(icon5)
                ...
                icon6 = QtGui.QIcon()
                icon6.addPixmap(QtGui.QPixmap(".\\Assets/A.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
                self.toolButton_escritura.setIcon(icon6)
                ...
                icon8 = QtGui.QIcon()
                icon8.addPixmap(QtGui.QPixmap(".\\Assets/freeDraw.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
                self.toolButton_dibujoLibre.setIcon(icon8)
                ...
                icon9 = QtGui.QIcon()
                icon9.addPixmap(QtGui.QPixmap(".\\Assets/Arrow 1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
                self.toolButton_flechas.setIcon(icon9)
        ...
        "border-radius: 15px;")
                ...
                self.frameDisposicion.setStyleSheet("background-color: #FFFFFF;\n"
        "\n"
        "")
                self.frameDisposicion.setFrameShape(QtWidgets.QFrame.NoFrame)
                self.frameDisposicion.setObjectName("frameDisposicion")
                self.frame_23 = QtWidgets.QFrame(self.frameDisposicion)
        ...
        "border-radius: 15px;")
                ...
                icon13 = QtGui.QIcon()
                icon13.addPixmap(QtGui.QPixmap(".\\Assets/2x2 grid.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
                self.dispositionButton_2x2.setIcon(icon13)
                ...
                icon14 = QtGui.QIcon()
                icon14.addPixmap(QtGui.QPixmap(".\\Assets/Rectangle 24.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
                self.dispositionButton_1x1.setIcon(icon14)
                ...
                icon15 = QtGui.QIcon()
                icon15.addPixmap(QtGui.QPixmap(".\\Assets/2x1grid.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
                self.dispositionButton_2x1.setIcon(icon15)
                ...
                icon16 = QtGui.QIcon()
                icon16.addPixmap(QtGui.QPixmap(".\\Assets/1x3grid.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
                self.dispositionButton_1x3.setIcon(icon16)
                ...
                icon17 = QtGui.QIcon()
                icon17.addPixmap(QtGui.QPixmap(".\\Assets/1x2grid.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
                self.dispositionButton_1x2.setIcon(icon17)
                ...
                icon18 = QtGui.QIcon()
                icon18.addPixmap(QtGui.QPixmap(".\\Assets/1up_2downgrid.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
                self.dispositionButton_1u2d.setIcon(icon18)
                ...
                icon19 = QtGui.QIcon()
                icon19.addPixmap(QtGui.QPixmap(".\\Assets/1+2grid.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
                self.dispositionButton_1l2r.setIcon(icon19)
                ...
                icon20 = QtGui.QIcon()
                icon20.addPixmap(QtGui.QPixmap(".\\Assets/3D.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
                self.dispositionButton_3D.setIcon(icon20)
        ...
        "border-radius: 15px;")
                ...
                self.filterLiner_db.setMaximumSize(QtCore.QSize(500, 16777215))
                self.filterLiner_db.setStyleSheet("border: 1px solid #A0A0A0;\n"
        "border-radius: 5px;\n"
        "padding: 2px;\n"
        "background-color: white;")
                self.filterLiner_db.setAlignment(QtCore.Qt.AlignCenter)
                self.filterLiner_db.setObjectName("filterLiner_db")
                self.horizontalLayout_10.addWidget(self.filterLiner_db)
        ...
        "}")
                ...
                item = QtWidgets.QTableWidgetItem()
                icon21 = QtGui.QIcon()
                icon21.addPixmap(QtGui.QPixmap(".\\Assets/trash.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
                item.setIcon(icon21)
        ...
        "border-radius: 15px;")
                ...
                icon22 = QtGui.QIcon()
                icon22.addPixmap(QtGui.QPixmap(":/icons/Assets/icon_documentUpload.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        def retranslateUi(self, MainWindow):
                ...
                MainWindow.setWindowTitle(_translate("MainWindow", "BRICOM"))
